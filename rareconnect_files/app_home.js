...
// init nav handler
function initHandleNav() {
    var navs = ["#about", "#how-work", "#features", "#get-infolved", "#text-section", "#benefits", "#community"];
    var navItem = $("#nav li");
    var position = [];
    ...
    navs.forEach(function (item) {
        position.push({
            id: item,
            top: $(item).offset() ? $(item).offset().top - 193 : 0,
            index: i
        });
        i++;
    });
    ...
    $(window).on("scroll", function () {
        ...
        position.forEach(function (item) {
            if (top >= item.top) {
                ...
                //navItem.eq(item.index).addClass('active');
            }
        });
    });
}
...
function initSearchForms() {
    jQuery('form.ajax-search').autoCompleteForm({
...
function initCarousel() {
    jQuery('.tabs-carousel').scrollGallery({
        mask: '.mask',
        slider: '.slideset',
        slides: '.slide',
        btnPrev: 'a.btn-prev',
...
function initCycleCarousel() {
    ...
    jQuery('.logos-gallery').scrollAbsoluteGallery({
        mask: '.mask',
        slider: '.slideset',
        slides: '.slide',
        btnPrev: 'a.btn-prev',
...
function initSameHeight() {
    jQuery('.other-websites .holder').sameHeight({
        elements: '.logo-holder',
        flexible: true,
        multiLine: true
    });
    ...
    jQuery('ul.involve-list').sameHeight({
        elements: 'li',
        flexible: true
    });
}
...
function initNotification() {
    $('.dismiss').on('click touch', function (e) {
        e.preventDefault();
        ...
        return this.each(function () {
            ...
            function updateDrop(text) {
                if (lastData != text) {
                    ...
                    listItems.each(function () {
                        ...
                        var content = curItem.children();
                        if (!content.hasClass('noData')) {
                            curItem.click(function (event) {
                                event.preventDefault();
                                var preventClick = $(curItem.data("orightml")).attr("prevent-click");
                                var clickable = !preventClick;
                                if (clickable)
            ...
            function selectItem(obj, realEvent) {
                ...
                if (opt.listItemsFillsInput) {
                    ...
                    window.location.href = $(obj.data("orightml")).attr("href");
                    return false;
                } else {
                    // example redirect
                    if (!realEvent) {
...
(function ($) {
    ...
    (function () {
        var tabStyleSheet = $('<style type="text/css">') === undefined ? null : $('<style type="text/css">')[0];
        var tabStyleRule = '.' + slideHiddenClass;
        tabStyleRule += '{position:absolute !important;left:-9999px !important;top:-9999px !important;display:block !important}';
        if (tabStyleSheet != null) {
